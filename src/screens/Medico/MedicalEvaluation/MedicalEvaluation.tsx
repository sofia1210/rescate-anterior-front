          ...
          evaluations.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {evaluations.map((ev: any, idx: number) => (
                <div key={ev.id || idx} className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="bg-white p-6 rounded-lg shadow text-center text-gray-600">No hay evaluaciones registradas.</div>
          )
        )}
      </div>
    </div>
